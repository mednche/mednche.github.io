...
1. Breeds the population: Creates lambda (\lambda) offspring from mu parents in the population: 
...
2. Selects survivors: Selects mu (\mu) survivors amongst the lambda offspring using the chosen selection algorithm.
