...
feature-img: ""
thumbnail: "/images/project/thumbs/CFS_playback.jpg"
...
1. Breed population: Create lambda offspring from mu parents in the population: 
- crossover (pair of parents) with additional possible mutation, or
- cloning (one parent) with additional possible mutation.

If mutating the offspring, all feature in the individual have the same independant probability of being mutated.

2. Survivor selection: Select mu survivors amongst the lambda offspring using the chosen selection algorithm.
This applies a selective pressure and maintain the population size mu constant across generations.
